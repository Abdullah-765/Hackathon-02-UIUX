...
export default function LatestProducts(){
   return (
    <div>
    <div id="latest-products" className='mx-[20px] mt-[45px]'>
    <h2 className={`${josefinSans.className} mt-6 mb-1 text-center text-[26px] text-[#1A0B5B] font-bold`}>Latest Products</h2>
      ...
      <ul className="grid grid-cols-2 gap-[20px]" id="latest-products">
        ...
        <div className="flex items-center justify-center flex-col relative shadow-sm" id="sale-product">
